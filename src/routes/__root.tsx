...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Neuromarketing Capsule — Mahindra Finance" },
      { name: "description", content: "Behavioral Intelligence Platform for Rural Financial Marketing — Mahindra Finance internal." },
      { name: "author", content: "Mahindra Finance" },
